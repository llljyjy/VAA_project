...
write.csv(countries_with_complete_data, file = "C:/FirGhAZ/VAA_project/data/aspatial/countries_with_complete_data.csv")
```
...
```{r}
BMIdata <- read_csv("C:/FirGhAZ/VAA_project/data/aspatial/countries_with_complete_data.csv")
```
```{r}
